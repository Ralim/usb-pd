...
private:
   ...
   *
   * Because the PHY can automatically send retries, the Check_RetryCounter
   * state has been removed, transitions relating to it are modified
   * appropriately, and we don't even keep a RetryCounter.
   */
  ...
  static Notifications waitForEvent(uint32_t mask,
