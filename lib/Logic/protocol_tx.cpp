 ...
 */
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_wait_message() {
  /* Wait for an event */
  ProtocolTransmit::Notifications evt =
      waitForEvent((uint32_t)Notifications::PDB_EVT_PRLTX_RESET |
 ...
 */
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_construct_message() {
 ...
 */
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_wait_response() {
 ...
 */
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_match_messageid() {
...
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_transmission_error() {
...
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_message_sent() {
...
ProtocolTransmit::protocol_tx_state
ProtocolTransmit::protocol_tx_discard_message() {
...
ProtocolTransmit::Notifications
ProtocolTransmit::waitForEvent(uint32_t mask, TickType_t ticksToWait) {
