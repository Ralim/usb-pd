...
/* Message types */
#define PD_MSGTYPE_GET(msg)                                                    \
  (((msg)->hdr & PD_HDR_MSGTYPE) >> PD_HDR_MSGTYPE_SHIFT)
/* Control Message */
...
/* Message ID */
#define PD_MESSAGEID_GET(msg)                                                  \
  (((msg)->hdr & PD_HDR_MESSAGEID) >> PD_HDR_MESSAGEID_SHIFT)
...
/* Data size */
#define PD_DATA_SIZE(n)                                                        \
  (((n) << PD_EXTHDR_DATA_SIZE_SHIFT) & PD_EXTHDR_DATA_SIZE)
#define PD_DATA_SIZE_GET(msg)                                                  \
  (((msg)->exthdr & PD_EXTHDR_DATA_SIZE) >> PD_EXTHDR_DATA_SIZE_SHIFT)

/* Chunk number */
#define PD_CHUNK_NUMBER(n)                                                     \
  (((n) << PD_EXTHDR_CHUNK_NUMBER_SHIFT) & PD_EXTHDR_CHUNK_NUMBER)
...
#define PD_PDO_SRC_FIXED_DUAL_ROLE_PWR                                         \
  (1 << PD_PDO_SRC_FIXED_DUAL_ROLE_PWR_SHIFT)
...
#define PD_PDO_SRC_FIXED_UNCONSTRAINED                                         \
  (1 << PD_PDO_SRC_FIXED_UNCONSTRAINED_SHIFT)
...
#define PD_PDO_SRC_FIXED_DUAL_ROLE_DATA                                        \
  (1 << PD_PDO_SRC_FIXED_DUAL_ROLE_DATA_SHIFT)
#define PD_PDO_SRC_FIXED_UNCHUNKED_EXT_MSG_SHIFT 24
#define PD_PDO_SRC_FIXED_UNCHUNKED_EXT_MSG                                     \
  (1 << PD_PDO_SRC_FIXED_UNCHUNKED_EXT_MSG_SHIFT)
#define PD_PDO_SRC_FIXED_PEAK_CURRENT_SHIFT 20
#define PD_PDO_SRC_FIXED_PEAK_CURRENT                                          \
  (0x3 << PD_PDO_SRC_FIXED_PEAK_CURRENT_SHIFT)
...
#define PD_APDO_PPS_CURRENT_SET(i)                                             \
  (((i) << PD_APDO_PPS_CURRENT_SHIFT) & PD_APDO_PPS_CURRENT)

/* PD Sink Fixed PDO */
#define PD_PDO_SNK_FIXED_DUAL_ROLE_PWR_SHIFT 29
#define PD_PDO_SNK_FIXED_DUAL_ROLE_PWR                                         \
...
#define PD_PDO_SNK_FIXED_UNCONSTRAINED                                         \
  (1 << PD_PDO_SNK_FIXED_UNCONSTRAINED_SHIFT)
...
#define PD_PDO_SNK_FIXED_DUAL_ROLE_DATA                                        \
  (1 << PD_PDO_SNK_FIXED_DUAL_ROLE_DATA_SHIFT)
...
#define PD_RDO_OBJPOS_GET(msg)                                                 \
  (((msg)->obj[0] & PD_RDO_OBJPOS) >> PD_RDO_OBJPOS_SHIFT)
...
#define PD_RDO_FV_CURRENT_SET(i)                                               \
  (((i) << PD_RDO_FV_CURRENT_SHIFT) & PD_RDO_FV_CURRENT)
#define PD_RDO_FV_MAX_CURRENT_SET(i)                                           \
  (((i) << PD_RDO_FV_MAX_CURRENT_SHIFT) & PD_RDO_FV_MAX_CURRENT)
...
#define PD_RDO_FV_MIN_CURRENT_SET(i)                                           \
  (((i) << PD_RDO_FV_MIN_CURRENT_SHIFT) & PD_RDO_FV_MIN_CURRENT)
...
#define PD_RDO_PROG_VOLTAGE_SET(i)                                             \
  (((i) << PD_RDO_PROG_VOLTAGE_SHIFT) & PD_RDO_PROG_VOLTAGE)
#define PD_RDO_PROG_CURRENT_SET(i)                                             \
  (((i) << PD_RDO_PROG_CURRENT_SHIFT) & PD_RDO_PROG_CURRENT)
